...
from scripts.brevig import wavelength, xy_ref, var_atmo

pathres = Path('/home/simon/Work/gie/processed/brevig/2023/hadamard/')
pathstack = Path('/home/simon/Work/gie/stacks/brevig/2023/hadamard/geocoded/')
# ll, ur = (-166.4970, 65.3100), (-166.4100, 65.3460)
ll, ur = (-166.5200, 65.3100), (-166.4100, 65.3500)

ind_K, var_thresh = -1, 9.0e-5
