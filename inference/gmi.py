...
def _condition_gm(
    ...
    if method_condition == 'sqr':
        ...
        mu_p_k = mu_k + np.einsum('pb, mbc, mc -> mp', Sigma_k_off, Sigma_k_obs_inv, dy, optimize=True)
        Sigma_p_k = Sigma_k - np.einsum(
...
if __name__ == '__main__':
    ...
    # need to refactor inversion and synthetic to be more general
